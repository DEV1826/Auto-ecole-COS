// src/features/caisse/components/index.ts

/**
 * @module features/caisse/components
 * @description
 * Composants pour la gestion de la caisse : tableau des mouvements, cartes statistiques.
 */
